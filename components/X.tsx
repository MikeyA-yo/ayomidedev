const X = ({ size, color, className }:{size?:string | number, color?:string, className:string}) => {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" className ={className} height={size} viewBox="0 0 512 512">
